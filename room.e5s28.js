    ...
    run: function () {
        ...
        if (sum_energy < 500) {
            ...
            if (TH.length < Num_Harvester && THB.length === 0) {
                Game.spawns.E5S28_Spawn1.spawnCreep([WORK, CARRY, MOVE], 'E5S28harvester' + Game.time, {
                    memory: {
                        role: 'E5S28harvester'
                    }
                });
            ...
            if (TB.length < Num_Builder) {
                Game.spawns.E5S28_Spawn1.spawnCreep([WORK, WORK, CARRY, CARRY, MOVE, MOVE], 'E5S28builder' + Game.time, {
                    memory: {
                        role: 'E5S28builder'
                    }
                });
            ...
            if (TR.length < Num_Repairer) {
                Game.spawns.E5S28_Spawn1.spawnCreep([WORK, WORK, CARRY, CARRY, MOVE, MOVE], 'E5S28repairer' + Game.time, {
                    memory: {
                        role: 'E5S28repairer'
                    }
                });
            ...
            if (THB.length < Num_HarvesterBIG) {
                Game.spawns.E5S28_Spawn1.spawnCreep([WORK, WORK, CARRY, CARRY, MOVE, MOVE], 'E5S28harvesterBIG' + Game.time, {
                    memory: {
                        role: 'E5S28harvesterBIG'
                    }
                });
                console.log('Spawning new -----');
            }
            if (TU.length < Num_Upgrader) {
                Game.spawns.E5S28_Spawn1.spawnCreep([WORK, WORK, CARRY, CARRY, MOVE, MOVE], 'E5S28upgrader' + Game.time, {
                    memory: {
                        role: 'E5S28upgrader'
                    }
                });
            ...
            if (THT.length < Num_HT) {
                ...
                if (container.length) {
                    for (var name in container) {
                        aaa = Game.spawns.E5S28_Spawn1.spawnCreep([WORK, WORK, WORK, WORK, CARRY, MOVE], container[name].id, {
                            memory: {
                                role: 'E5S28harvesterToContainer'
                            }
                        });
