...
var roomE5S39 = {
    ...
    run: function () {
        ...
        var Num_Harvester = 2; var Num_Upgrader = 3; var Num_Builder = 3; var Num_Repairer = 1; Num_Warior = 0;
        ...
        var TW = _.filter(Game.creeps, (creep) => creep.memory.role == 'E5S29warior');
        console.log('E5S29:', sum_energy, '/', sum_energyCapacity, 'H' + TH.length, 'U' + TU.length, 'B' + TB.length, 'R' + TR.length)
        if (sum_energy <= 300) {
        ...
        for (var name in Game.creeps) {
            ...
            if (creep.room.name == 'E5S29') {
                ...
                if (creep.memory.role == 'E5S29warior') {
