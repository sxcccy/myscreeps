...
function towerDefence(id) {
    ...
    var towerpower = tower.room.find(FIND_STRUCTURES, { filter: (structure) => { return structure.structureType == STRUCTURE_TOWER; } }).length * 150;
    var myRangedAttackCreeps = tower.room.find(FIND_MY_CREEPS);
    var Hostiles = tower.room.find(FIND_HOSTILE_CREEPS);
    var enemyHeal = 0; var creeppower = 0;  
